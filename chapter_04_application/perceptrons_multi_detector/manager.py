...
def main(
    ...
    manager = gf.Manager(
        ...
        log_directory_path = Path("./chapter_04_application/perceptrons_multi_detector/models/logs")
    )
...
if __name__ == "__main__":
    ...
    training_script_path : Path = Path("./chapter_04_application/perceptrons_multi_detector/train.py")
